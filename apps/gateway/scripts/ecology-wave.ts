...
if (!spec) {
  console.error(`usage: ecology-wave.ts <1|2|control|e2a|e2b|e2c|e2d|e2e|nano-test|nano2|nano3|nano4|eager|eager2|observers|pa2|hackers|wave4> [ticks] [tickSeconds]`);
  process.exit(1);
...
for (let i = 0; i < spec.size; i++) {
  ...
  population.push({
    index: i,
    name: `Eco${wave === "control" ? "C" : wave === "e2a" ? "E2A" : wave === "e2b" ? "E2B" : wave === "e2c" ? "E2C" : wave === "e2d" ? "E2D" : wave === "e2e" ? "E2E" : wave === "nano2" ? "N2" : wave === "nano3" ? "N3" : wave === "nano4" ? "PA" : wave === "eager" ? "EG" : wave === "eager2" ? "E2" : wave === "observers" ? "OB" : wave === "pa2" ? "P2" : wave === "hackers" ? "EH" : wave === "stalkers" ? "ES" : wave === "strollers" ? "EW" : wave === "advertisers" ? "EA" : wave === "wave4" ? "W4" : `W${wave}`}-${i + 1}`,
    family: wave === "wave4" ? (i < 5 ? "nano-class" : "gptoss20-class") : wave === "nano-test" || wave === "nano2" || wave === "nano3" || wave === "nano4" || wave === "eager" || wave === "eager2" || wave === "observers" || wave === "pa2" || wave === "hackers" || wave === "stalkers" || wave === "strollers" || wave === "advertisers" ? "nano-class" : pick(FAMILIES, rModel()),
    caps,
    mandateComplete: true,
