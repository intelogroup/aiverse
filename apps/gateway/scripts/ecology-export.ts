...
const expectedSize = { "1": 10, "2": 8, "3": 8, control: 5, e2a: 3, e2b: 4, e2c: 20, e2d: 20, e2e: 20, "nano-test": 5, nano2: 5 }[wave as "1" | "2" | "3" | "control" | "e2a" | "e2b" | "e2c" | "e2d" | "e2e" | "nano-test" | "nano2"];
