CREATE TYPE "public"."goal_status" AS ENUM('open', 'researching', 'synthesized', 'closed');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "a2a_tasks" ADD COLUMN "caller_message_id" text;--> statement-breakpoint
ALTER TABLE "a2a_tasks" ADD COLUMN "delegation_lease_expires_at" timestamp;--> statement-breakpoint
ALTER TABLE "agent_policy_scope" ADD COLUMN "max_parallel_delegations" integer DEFAULT 3 NOT NULL;--> statement-breakpoint
ALTER TABLE "agents" ADD COLUMN "is_native" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "agents" ADD COLUMN "personality_prompt" text;--> statement-breakpoint
ALTER TABLE "agents" ADD COLUMN "soul" jsonb;--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "display_name" text;--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "email_verified" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "owners" ADD COLUMN "email_verification_token" text;--> statement-breakpoint
DO $$ BEGIN
